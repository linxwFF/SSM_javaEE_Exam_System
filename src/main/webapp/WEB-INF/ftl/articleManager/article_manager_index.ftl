                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <!-- 判读是否拥有删除的权限 -->
                        <@shiro.hasPermission name="/articleManager/deleteArticleById.shtml">
                            <input type="hidden" name="hasDel" value="1">
                        </@shiro.hasPermission>
                            <!-- 判读是否拥改变文章发布状态的权限 -->
                        <@shiro.hasPermission name="/articleManager/ChangeStateById.shtml">
...
<script type="text/javascript" charset="utf8" src="${basePath}/static/build/js/article_manager_index.js"></script>
